          ...
          <Container>
            <Row className="header-box d-flex align-items-center pt-lg-5">
              <Col lg="6">
                ...
                <p className="mb-4">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iure, nesciunt labore repellat fuga sapiente deleniti.</p>
                <button className="btn btn-danger btn-1g rounded-1 me-2 mb-xs-0 mb-2" onClick={() => navigate("kelas")}>Lihat Kelas</button>
                <button className="btn btn-outline-danger btn-1g rounded-1 mb-xs-0 mb-2">Lihat promo</button>
              </Col>
          ...
          <container>
            ...
            <Row>
              ...
              <button className="btn btn-success rounded-5 btn-lg" onClick={() => navigate("/kelas")}>
                Lihat Semua Kelas <i className="fa-solid fa-chevron-riht ms-1"></i>
              </button>
              </Col>
            </Row>
          </container>
