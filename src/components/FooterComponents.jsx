    ...
    <div className="footer py-5">
      <Container>
        <Row className="d-flex justify-content-between" data-aos="fade-up" data-aos-duration="1000">
          ...
          <p className="desc">Kami Sagara Vote Menyediakan Akses untuk memilih atau mendukung youtuber favorit kalian semua</p>
          ...
          <div className="mail">
            ...
            <p className="m-0">SagaraVote@gmail.com</p>
            </Link>
          </div>
          </Col>
        ...
        <Row>
          <Col>
          <p className="text-center px-md-0 px-3" data-aos="fade-up" data-aos-duration="1000">&copy; copyright {new Date() .getFullYear()} by <span className="fw-bold">Sagara</span> , all right reserved</p>
          </Col>
        </Row>
      </Container>
    </div>
